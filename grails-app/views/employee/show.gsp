	...
	<body>
		...
		<div id="show-employee" class="content scaffold-show" role="main">
			...
			<ol class="property-list employee">
				...
				<g:if test="${employeeInstance?.office}">
				<li class="fieldcontain">
					<span id="office-label" class="property-label"><g:message code="employee.office.label" default="Office" /></span>
					
						<span class="property-value" aria-labelledby="office-label"><g:fieldValue bean="${employeeInstance}" field="office"/></span>
